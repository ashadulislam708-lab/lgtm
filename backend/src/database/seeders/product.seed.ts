...
const PRODUCT_TEMPLATES: Record<
    string,
    { names: string[]; priceRange: [number, number] }
> = {
    Electronics: {
        names: [
...
export async function seedProducts(dataSource: DataSource): Promise<Product[]> {
    ...
    products.push(
        {
            ...
            description:
                'Deterministic test product for API testing. Category: Electronics.',
            price: 25.0,
        ...
        },
        {
            ...
            description:
                'Deterministic test product for API testing. Category: Clothing.',
            price: 75.0,
            category: 'Clothing',
            sku: 'TEST-PROD-002',
            stockQuantity: 50,
        ...
        },
        {
            ...
            description:
                'Deterministic test product for API testing. Category: Books.',
            price: 15.0,
            category: 'Books',
            sku: 'TEST-PROD-003',
            stockQuantity: 200,
    ...
    console.log(
        `Created ${savedProducts.length} products across ${CATEGORIES.length} categories`,
    );
